(() => {
  ...
  aa.prototype._$P7 = function (aK, aR, aH, a0) {
    ...
    if (aH == 0) {
      for (var aV = 0; aV < aK.length; aV++) {
        var aP = aK[aV];
        var aO = aR[aV];
        var aS = this.getParamFloat(aP) != 0;
        this.setPartsOpacity(aO, aS ? 1 : 0);
      }
      return;
    } else {
      if (aK.length == 1) {
        var aP = aK[0];
        var aT = this.getParamFloat(aP) != 0;
        var aO = aR[0];
        var aQ = this.getPartsOpacity(aO);
        var aW = aH / a0;
        if (aT) {
          aQ += aW;
          if (aQ > 1) {
        ...
        if (aU < 0) {
          ...
          aY = 1;
          this.loadParam();
          this.setParamFloat(aK[aU], aY);
          this.saveParam();
        }
        for (var aV = 0; aV < aK.length; aV++) {
          var aO = aR[aV];
          if (aU == aV) {
            this.setPartsOpacity(aO, aY);
          } else {
            var aL = this.getPartsOpacity(aO);
            var aZ;
            if (aY < aJ) {
              aZ = (aY * (aJ - 1)) / aJ + 1;
            } else {
  ...
  W.prototype.calcClippedDrawTotalBounds = (a6, aV) => {
  ...
  ah.prototype.getDurationMSec = () => -1;
  ah.prototype.getLoopDurationMSec = () => -1;
  ...
  ah.prototype.updateParamExe = (aH, aI, aJ, aK) => {};
  function q() {}
  q._$8s = 0;
  q._$fT = new Object();
  q.start = (aI) => {
  ...
  X.prototype._$e = () => {};
  var ad = () => {};
  ad._$ni = (aL, aJ, aR, aQ, aK, aI, aH, aS, aN) => {
    var aM = aH * aI - aS * aK;
    if (aM == 0) {
      return null;
    } else {
  ...
  aG._$Vr = (bV, bW, a5, aI, bC, a3, bX, bH) => {
  ...
  ae._$or = () => ae._$52;
  ae._$Pr = () => ae._$R2;
  ae.prototype.convertClipIDForV2_11 = (aI) => {
    var aH = [];
    if (aI == null) {
      return null;
    }
  ...
  ae.prototype.getOpacity = (aH, aI) => aI._$7s;
  ae.prototype._$zS = (aH, aI) => aI._$Us;
  ae.prototype._$MS = (aJ) => {
  ...
  ae.prototype.preDraw = (aJ, aH, aI) => {};
  ae.prototype.draw = (aJ, aH, aI) => {};
  ae.prototype.getType = () => {};
  ae.prototype._$B2 = (aI, aH, aJ) => {};
  function ax() {
    if (j) {
      return;
    }
  ...
  ax.prototype._$ZT = () => {};
  ax.prototype._$Uo = (aM, aK, aJ, aL, aN, aI, aH) => {};
  ax.prototype._$Rs = () => -1;
  ax.prototype._$Ds = (aH) => {};
  ...
  c.prototype._$2b = (aI, aH) => {};
  c.prototype._$nb = (aL, aK, aM, aH, aI, aJ, aN) => {};
  c.prototype.getType = () => {};
  ...
  P.getUserTimeMSec = () => (P._$CS == P._$W2 ? P.getSystemTimeMSec() : P._$CS);
  P.setUserTimeMSec = (aH) => {
    P._$CS = aH;
  };
  P.updateUserTimeMSec = () => (P._$CS = P.getSystemTimeMSec());
  P.getTimeMSec = () => new Date().getTime();
  P.getSystemTimeMSec = () => new Date().getTime();
  P._$Q = (aH) => {};
  P._$jT = (aM, aJ, aI, aL, aH) => {
  ...
  G.getChar = (aI, aH) => String.fromCharCode(aI.getUint8(aH));
  G.createString = (aM, aL, aJ) => {
  ...
  ac.prototype.mult_fast = (aI, aH, aK, aJ) => {
    if (aJ) {
  ...
  ab.prototype._$Jr = (aP, aK, aI, aR, aQ, aH) => {
    if (!(aK == aI._$GT())) {
      console.log("### assert!! ### ");
    }
    var aO = ab._$Lo;
  ...
  a.prototype.getOpacity = (aH, aI) => aI._$7s;
  a.prototype._$zS = (aH, aI) => aI._$Us;
  ...
  E.transformPoints_sdk2 = (a0, bc, a5, aP, aI, aR, aQ, aU) => {
    var aW = a5 * aI;
    var aV;
    var bn, bm;
    var aT = 0;
  ...
  au.expandClip = (aV, bg, aK, a3, aJ, aI, be, ba, aZ, aX) => {
    var aP = be - aJ;
    var aO = ba - aI;
    var bi = aZ - aJ;
    var bh = aX - aI;
  ...
  au.clipWithTransform = (aH, aI, aS, aN, aQ, aK, aP, aJ) => {
  ...
  Q.getVersionStr = () => Q._$2s;
  Q.getVersionNo = () => Q._$Kr;
  Q._$sT = (aH) => {
    Q._$cT = aH;
  };
  Q.getError = () => {
  ...
  Q.getGL = (aH) => Q.glContext[aH];
  Q.setClippingMaskBufferSize = (aH) => {
    Q.clippingMaskBufferSize = aH;
  };
  Q.getClippingMaskBufferSize = () => Q.clippingMaskBufferSize;
  Q.deleteBuffer = (aI) => {
    var aH = Q.getGL(aI);
  ...
  aC._$9 = (aH) => Math.sin(aH);
  aC.fcos = (aH) => Math.cos(aH);
  function aB(aH) {
    if (j) {
      return;
    }
